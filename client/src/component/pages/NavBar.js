...
function NavBar() {
	...
	let navbarCart = useSelector((state) => state.cart);
	console.log('cartNavbar', navbarCart);
	return (
		<div>
            ...
            --> */}
				...
				<main>
					<div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-4 flex ">
						<div className="w-1/5">{location == '/' ? <Filter /> : ''}</div>
