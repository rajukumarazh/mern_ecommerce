...
import { decided } from '../../../redux/actions/renderAction';
import { useSelector } from 'react-redux';
function Sidebar() {
	const dispatch = useDispatch(decided);
			...
			<aside className="w-64" aria-label="Sidebar">
				<div className="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
					...
					<ul className="space-y-2">
						...
						<li>
							<button
								onClick={async () => dispatch(decided(3))}
								className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
							>
								<svg
									aria-hidden="true"
						...
						<li>
							<button
								// onClick={dispatch(decided(0))}
								onClick={async () => dispatch(decided(0))}
								className={`flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 
						...
						<li>
							<button
								onClick={async () => dispatch(decided(1))}
								className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700"
							>
								<svg
									aria-hidden="true"
